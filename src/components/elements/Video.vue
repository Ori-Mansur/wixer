<template>
  <section class="video-container" >
    <div class="vid-tool" >
      ...
      <label @click="removeElement" title="remove this widget" v-show="!isInput">
        <unicon name="trash-alt" fill="black" class="icon-edit" />
      </label>
       <input :id="fileUpload" type="url" v-show="isInput" v-model="url" class="vid-input" />
       <button v-show="isInput" class="vid-btn">Set</button>
    </div>
